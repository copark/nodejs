...
function initCollection(){
	...
	// member collection 생성
	db.createCollection("member", function(err, member){
		db.member = member;
		clog.info("member 컬렉션 생성.");
		// shop collection 생성
		db.createCollection("shop", function(err, shop){
			db.shop = shop;
			clog.info("shop 컬렉션 생성.");
			// coupon collection 생성
			db.createCollection("coupon", function(err, coupon){
				db.coupon = coupon;
				clog.info("coupon 컬렉션 생성.");
				// purchase collection 생성
				db.createCollection("purchase", function(err, purchase){
					db.purchase = purchase;
					clog.info("purchase 컬렉션 생성.");
					// epilogue collection 생성
					db.createCollection("epilogue", function(err, epilogue){
						db.epilogue = epilogue;
						clog.info("epilogue 컬렉션 생성.");
						clog.info("collection 생성 완료.");
	...
	db.shop.find().toArray(function(err, shops){
		...
		var coupons = [
       		...
       		},
       		{
       			...
       			shopId: shopObjId[0]._id, 
       			region: "신촌",
       			position: {lat: 37.557709, lng: 126.936650},
       			couponName: "널부 쭈꾸미", 
       			primeCost: 28000, 
       			price: 15000, 
       			quantity: 75, 
       		...
       		},
       		{
       			...
       			shopId: shopObjId[1]._id, 
       			region: "신촌",
       			position: {lat: 37.554638, lng: 126.934676},
       			couponName: "정로곱창", 
       			primeCost: 38000, 
       			price: 20000, 
       			quantity: 37, 
	...
	var purchases = [
  		{
  			...
  			quantity: 1, 
  			paymentInfo: {cardType: "KB", cardNumber: "123", cardExpireDate: "201505", csv: "567", price: "6000"},
  		...
  		},
  		{
  			...
  			email: "uzoolove@gmail.com", 
  			quantity: 10, 
  			paymentInfo: {cardType: "KB", cardNumber: "123", cardExpireDate: "201505", csv: "567", price: "120000"},
  		...
  		},
  		{
  			...
  			email: "test", 
  			quantity: 2, 
  			paymentInfo: {cardType: "KB", cardNumber: "123", cardExpireDate: "201505", csv: "567", price: "24000"},
  		...
  		},
  		{
  			...
  			email: "test", 
  			quantity: 1, 
  			paymentInfo: {cardType: "KB", cardNumber: "123", cardExpireDate: "201505", csv: "567", price: "10000"},
  		...
  		},
  		{
  			...
  			email: "seulbinim@gmail.com", 
  			quantity: 1, 
  			paymentInfo: {cardType: "KB", cardNumber: "123", cardExpireDate: "201505", csv: "567", price: "4700"},
  		...
  		},
  		{
  			...
  			email: "test", 
  			quantity: 2, 
  			paymentInfo: {cardType: "KB", cardNumber: "123", cardExpireDate: "201505", csv: "567", price: "9400"},
  			regDate: new Date(now-60*60*24*3)	
  		},
  		{
  			couponId: couponObjId[15], 
  			email: "uzoolove@gmail.com", 
  			quantity: 5, 
  			paymentInfo: {cardType: "KB", cardNumber: "123", cardExpireDate: "201505", csv: "567", price: "23500"},
   			regDate: new Date(now-60*60*24*1)	
  		}
  	];
